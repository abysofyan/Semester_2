...
<div class="flex h-screen overflow-hidden">
    <!-- Sidebar -->
    <aside id="sidebar"
           class="bg-green-700 text-white w-64 flex-shrink-0 transition-all duration-300 ease-in-out transform -translate-x-full md:translate-x-0 fixed md:static h-full z-40">
        <div class="p-4">
            ...
            <nav class="space-y-1">
                ...
                foreach ($tables as $table): ?>
                    <a href="app.php?table=<?= $table ?>"
                       class="flex items-center px-3 py-2.5 rounded-md transition-colors <?= $currentTable === $table ? 'bg-green-800 text-white' : 'text-green-100 hover:bg-green-800 hover:text-white' ?>">
            ...
            <div class="absolute bottom-4 left-0 right-0 px-4 text-center text-xs text-green-200">
                &copy; 2025 Puskesmas 
            </div>
        </div>
    </aside>
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <main class="flex-1 overflow-y-auto p-4">
            <div class="container mx-auto max-w-6xl">
                <div class="mb-6">
                    <h2 class="text-2xl font-semibold text-gray-800"><?= ucfirst($currentTable) ?> Registration System </h2>
                ...
                <div class="bg-white rounded-lg shadow-sm mb-6 overflow-hidden">
                    <div class="border-b border-gray-200 px-5 py-3 flex items-center">
                        <i class="fas <?= $editId ? 'fa-edit' : 'fa-plus' ?> mr-2 text-green-600"></i>
                    ...
                    <div class="p-6 bg-white rounded-xl shadow-md">
                        <form method="POST" action="app.php" class="space-y-6">
                            ...
                            <div class="flex justify-end gap-3 pt-4 border-t border-gray-100">
                                ...
                                <button type="submit"
                                        class="px-5 py-2 text-sm font-medium text-white bg-green-600 rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-green-500">
                                    <?= $editId ? 'Update' : 'Save' ?>
                                </button>
                            </div>
                        </form>
